      ...
      tr.innerHTML = `
        ...
        <td class="px-6 py-4 text-right whitespace-nowrap">
          <div class="inline-flex items-center space-x-3">
            ...
            <button type="button" onclick="if(typeof openModuleAccessModal === 'function') openModuleAccessModal(${role.role_id}, '${(role.role_name || '').replace(/'/g, "\\'")}')" class="text-slate-400 hover:text-brand-dark hover:bg-slate-100 p-1.5 rounded-lg border border-slate-200 transition cursor-pointer" title="Capstone Module Access (local)">
